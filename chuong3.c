...
uint64_t key;
//module_param(key, uint64_t, S_IRUGO);
...
static int __init F_init(void) {
    ...
    key = 0x4784c4ba5006081f;
    uint64_t key1 = 0x7bfc5dc6adb5797c;
    ...
    printk (KERN_INFO "Ket qua test lan 1");
    printk (KERN_INFO "IUPUT: %016llx\n", result);
    printk (KERN_INFO "KEY: %016llx\n", key);
    result = des(result, key, 'e');
    printk (KERN_INFO "Encryption: %016llx\n", result);
    result = des(result, key, 'd');
    printk (KERN_INFO "Decryption: %016llx\n", result);
    
    
    
    printk (KERN_INFO "");
    printk (KERN_INFO "Ket qua test lan 2");
    printk (KERN_INFO "IUPUT: %016llx\n", result);
    printk (KERN_INFO "KEY: %016llx\n", key1);
    result = des(result, key1, 'e');
    printk (KERN_INFO "Encryption: %016llx\n", result);
    result = des(result, key1, 'd');
    printk (KERN_INFO "Decryption: %016llx\n", result);
